...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wajh6x8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wajh6x8.containers.anotherwebservice.com/
...
```
git clone git@github.com:lczpln/container-wajh6x8.git
cd container-wajh6x8
```
...
```
docker attach container-wajh6x8
```
